...
/>
    ...
    <p className="project-heading text-white ml-20 text-xl font-semibold mt-5">UI/UX Design</p>
        <div className=" project-cards flex flex-wrap justify-center">
        <div className="h-[30rem] flex items-center justify-center ">
          <PinContainer
            title="/modamuse.com"
